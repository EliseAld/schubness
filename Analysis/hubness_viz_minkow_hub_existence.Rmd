...
# Viz
max_9047 <- get_max(hubness,"9047", ymin=9, ymax=10)
max_5000 <- get_max(hubness,"5000", ymin=8, ymax=9)
max_1000 <- get_max(hubness,"1000", ymin=7, ymax=8)
max_500 <- get_max(hubness,"500", ymin=6, ymax=7)
max_100 <- get_max(hubness,"100", ymin=5, ymax=6)
max_50 <- get_max(hubness,"50", ymin=4, ymax=5)
max_10 <- get_max(hubness,"10", ymin=3, ymax=4)
max_5 <- get_max(hubness,"5", ymin=2, ymax=3)
max_2 <- get_max(hubness,"2", ymin=1, ymax=2)
max_9047_log <- get_max(hubness_log,"9047", ymin=9, ymax=10)
max_5000_log <- get_max(hubness_log,"5000", ymin=8, ymax=9)
max_1000_log <- get_max(hubness_log,"1000", ymin=7, ymax=8)
max_500_log <- get_max(hubness_log,"500", ymin=6, ymax=7)
max_100_log <- get_max(hubness_log,"100", ymin=5, ymax=6)
max_50_log <- get_max(hubness_log,"50", ymin=4, ymax=5)
max_10_log <- get_max(hubness_log,"10", ymin=3, ymax=4)
max_5_log <- get_max(hubness_log,"5", ymin=2, ymax=3)
max_2_log <- get_max(hubness_log,"2", ymin=1, ymax=2)
