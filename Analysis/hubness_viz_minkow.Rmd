...
af_8$Dimension <- "5000"
af_9$Dimension <- "9047"
hubness <- rbind(aa_1,aa_2,aa_3,aa_4,aa_5,aa_6,aa_7,aa_8,aa_9,
...
rm(aa_1,aa_2,aa_3,aa_4,aa_5,aa_6,aa_7,aa_8,aa_9,
   ab_1,ab_2,ab_3,ab_4,ab_5,ab_6,ab_7,ab_8,ab_9,
   ac_1,ac_2,ac_3,ac_4,ac_5,ac_6,ac_7,ac_8,ac_9,
   ad_1,ad_2,ad_3,ad_4,ad_5,ad_6,ad_7ad_8,ad_9,
   ae_1,ae_2,ae_3,ae_4,ae_5,ae_6,ae_7,ae_8,ae_9,
   af_1,af_2,af_3,af_4,af_5,af_6,af_7,af_8,af_9)
hubness$Dimension <- factor(hubness$Dimension, levels = c("2","5","10","50","100","500","1000","5000","9047"))
# Removing cells with hubness score = 0
hubness <- hubness[hubness$Hubness_score != 0,]
# Log to zoom on differences
hubness_log <- hubness
hubness_log$Hubness_score <- log(hubness_log$Hubness_score)
# Viz
max_9047 <- get_max(hubness,"9047")
max_5000 <- get_max(hubness,"5000")
max_1000 <- get_max(hubness,"1000")
max_500 <- get_max(hubness,"500")
max_100 <- get_max(hubness,"100")
max_50 <- get_max(hubness,"50")
max_10 <- get_max(hubness,"10")
max_5 <- get_max(hubness,"5")
max_2 <- get_max(hubness,"2")
max_9047_log <- get_max(hubness_log,"9047")
max_5000_log <- get_max(hubness_log,"5000")
max_1000_log <- get_max(hubness_log,"1000")
max_500_log <- get_max(hubness_log,"500")
max_100_log <- get_max(hubness_log,"100")
max_50_log <- get_max(hubness_log,"50")
max_10_log <- get_max(hubness_log,"10")
max_5_log <- get_max(hubness_log,"5")
max_2_log <- get_max(hubness_log,"2")

ggplot(hubness, aes(x = Hubness_score, y = Dimension, fill = Dimension)) +
  geom_density_ridges() +
  theme_ridges() + 
  theme(legend.position = "none") +
  xlab("Hubness score") +
  ylab("Dimension of the input space") +
  geom_vline(aes(xintercept = max), max_9047, size=1, colour=hue_pal()(9)[9]) +
  geom_vline(aes(xintercept = max), max_5000, size=1, colour=hue_pal()(9)[8]) +
  geom_vline(aes(xintercept = max), max_1000, size=1, colour=hue_pal()(9)[7]) +
  geom_vline(aes(xintercept = max), max_500, size=1, colour=hue_pal()(9)[6]) +
  geom_vline(aes(xintercept = max), max_100, size=1, colour=hue_pal()(9)[5]) +
  geom_vline(aes(xintercept = max), max_50, size=1, colour=hue_pal()(9)[4]) +
  geom_vline(aes(xintercept = max), max_10, size=1, colour=hue_pal()(9)[3]) +
  geom_vline(aes(xintercept = max), max_5, size=1, colour=hue_pal()(9)[2]) +
  geom_vline(aes(xintercept = max), max_2, size=1, colour=hue_pal()(9)[1]) +
  facet_wrap( ~ k) +
  ggtitle('Hubness scores histogram with Lp norm,\np=0.1')
ggplot(hubness_log, aes(x = Hubness_score, y = Dimension, fill = Dimension)) +
  geom_density_ridges() +
  theme_ridges() + 
  theme(legend.position = "none") +
  xlab("Hubness score (log)") +
  ylab("Dimension of the input space") +
  geom_vline(aes(xintercept = max), max_9047_log, size=1, colour=hue_pal()(9)[9]) +
  geom_vline(aes(xintercept = max), max_5000_log, size=1, colour=hue_pal()(9)[8]) +
  geom_vline(aes(xintercept = max), max_1000_log, size=1, colour=hue_pal()(9)[7]) +
  geom_vline(aes(xintercept = max), max_500_log, size=1, colour=hue_pal()(9)[6]) +
  geom_vline(aes(xintercept = max), max_100_log, size=1, colour=hue_pal()(9)[5]) +
  geom_vline(aes(xintercept = max), max_50_log, size=1, colour=hue_pal()(9)[4]) +
  geom_vline(aes(xintercept = max), max_10_log, size=1, colour=hue_pal()(9)[3]) +
  geom_vline(aes(xintercept = max), max_5_log, size=1, colour=hue_pal()(9)[2]) +
  geom_vline(aes(xintercept = max), max_2_log, size=1, colour=hue_pal()(9)[1]) +
  facet_wrap( ~ k) +
  ggtitle('Hubness scores histogram with Lp norm,\np=0.1')
```

```{r test violin, p=0.1}
ggplot(hubness, aes(x=Dimension, y=Hubness_score, color=Dimension, fill=Dimension)) +
...
ggplot(hubness_log, aes(x=Dimension, y=Hubness_score, color=Dimension, fill=Dimension)) +
    geom_violin(width=1, size=0.8) +
    geom_jitter(position = position_jitter(0.2), cex=0.1, alpha = 0.1) +
    scale_fill_viridis(discrete=TRUE, alpha = 0.4) +
    scale_color_viridis(discrete=TRUE) +
...
bf_8$Dimension <- "5000"
bf_9$Dimension <- "9047"
hubness <- rbind(ba_1,ba_2,ba_3,ba_4,ba_5,ba_6,ba_7,ba_8,ba_9,
...
rm(ba_1,ba_2,ba_3,ba_4,ba_5,ba_6,ba_7,ba_8,ba_9,
   bb_1,bb_2,bb_3,bb_4,bb_5,bb_6,bb_7,bb_8,bb_9,
   bc_1,bc_2,bc_3,bc_4,bc_5,bc_6,bc_7,bc_8,bc_9,
   bd_1,bd_2,bd_3,bd_4,bd_5,bd_6,bd_7bd_8,bd_9,
   be_1,be_2,be_3,be_4,be_5,be_6,be_7,be_8,be_9,
   bf_1,bf_2,bf_3,bf_4,bf_5,bf_6,bf_7,bf_8,bf_9)
hubness$Dimension <- factor(hubness$Dimension, levels = c("2","5","10","50","100","500","1000","5000","9047"))
# Removing cells with hubness score = 0
...
cf_8$Dimension <- "5000"
cf_9$Dimension <- "9047"
hubness <- rbind(ca_1,ca_2,ca_3,ca_4,ca_5,ca_6,ca_7,ca_8,ca_9,
...
rm(ca_1,ca_2,ca_3,ca_4,ca_5,ca_6,ca_7,ca_8,ca_9,
   cb_1,cb_2,cb_3,cb_4,cb_5,cb_6,cb_7,cb_8,cb_9,
   cc_1,cc_2,cc_3,cc_4,cc_5,cc_6,cc_7,cc_8,cc_9,
   cd_1,cd_2,cd_3,cd_4,cd_5,cd_6,cd_7cd_8,cd_9,
   ce_1,ce_2,ce_3,ce_4,ce_5,ce_6,ce_7,ce_8,ce_9,
   cf_1,cf_2,cf_3,cf_4,cf_5,cf_6,cf_7,cf_8,cf_9)
hubness$Dimension <- factor(hubness$Dimension, levels = c("2","5","10","50","100","500","1000","5000","9047"))
# Removing cells with hubness score = 0
...
df_8$Dimension <- "5000"
df_9$Dimension <- "9047"
hubness <- rbind(da_1,da_2,da_3,da_4,da_5,da_6,da_7,da_8,da_9,
...
rm(da_1,da_2,da_3,da_4,da_5,da_6,da_7,da_8,da_9,
   db_1,db_2,db_3,db_4,db_5,db_6,db_7,db_8,db_9,
   dc_1,dc_2,dc_3,dc_4,dc_5,dc_6,dc_7,dc_8,dc_9,
   dd_1,dd_2,dd_3,dd_4,dd_5,dd_6,dd_7dd_8,dd_9,
   de_1,de_2,de_3,de_4,de_5,de_6,de_7,de_8,de_9,
   df_1,df_2,df_3,df_4,df_5,df_6,df_7,df_8,df_9)
hubness$Dimension <- factor(hubness$Dimension, levels = c("2","5","10","50","100","500","1000","5000","9047"))
# Removing cells with hubness score = 0
...
ef_8$Dimension <- "5000"
ef_9$Dimension <- "9047"
hubness <- rbind(ea_1,ea_2,ea_3,ea_4,ea_5,ea_6,ea_7,ea_8,ea_9,
...
rm(ea_1,ea_2,ea_3,ea_4,ea_5,ea_6,ea_7,ea_8,ea_9,
   eb_1,eb_2,eb_3,eb_4,eb_5,eb_6,eb_7,eb_8,eb_9,
   ec_1,ec_2,ec_3,ec_4,ec_5,ec_6,ec_7,ec_8,ec_9,
   ed_1,ed_2,ed_3,ed_4,ed_5,ed_6,ed_7ed_8,ed_9,
   ee_1,ee_2,ee_3,ee_4,ee_5,ee_6,ee_7,ee_8,ee_9,
   ef_1,ef_2,ef_3,ef_4,ef_5,ef_6,ef_7,ef_8,ef_9)
hubness$Dimension <- factor(hubness$Dimension, levels = c("2","5","10","50","100","500","1000","5000","9047"))
# Removing cells with hubness score = 0
...
ff_8$Dimension <- "5000"
ff_9$Dimension <- "9047"
hubness <- rbind(fa_1,fa_2,fa_3,fa_4,fa_5,fa_6,fa_7,fa_8,fa_9,
...
rm(fa_1,fa_2,fa_3,fa_4,fa_5,fa_6,fa_7,fa_8,fa_9,
   fb_1,fb_2,fb_3,fb_4,fb_5,fb_6,fb_7,fb_8,fb_9,
   fc_1,fc_2,fc_3,fc_4,fc_5,fc_6,fc_7,fc_8,fc_9,
   fd_1,fd_2,fd_3,fd_4,fd_5,fd_6,fd_7fd_8,fd_9,
   fe_1,fe_2,fe_3,fe_4,fe_5,fe_6,fe_7,fe_8,fe_9,
   ff_1,ff_2,ff_3,ff_4,ff_5,ff_6,ff_7,ff_8,ff_9)
hubness$Dimension <- factor(hubness$Dimension, levels = c("2","5","10","50","100","500","1000","5000","9047"))
# Removing cells with hubness score = 0
