...
```{r comp12 log, echo=FALSE}
# Merge the dfs
hubness_log <- rbind(hubness1_log,hubness2_log)
p1="0.1"
p2="0.5"
dif_9047 <- get_rectange(hubness_log, kval=c(5,10,20,50,100,200),dim="9047",p1=p1,p2=p2,ymin=9,ymax=10)
dif_5000 <- get_rectange(hubness_log, kval=c(5,10,20,50,100,200),dim="5000",p1=p1,p2=p2,ymin=8,ymax=9)
dif_1000 <- get_rectange(hubness_log, kval=c(5,10,20,50,100,200),dim="1000",p1=p1,p2=p2,ymin=7,ymax=8)
dif_500 <- get_rectange(hubness_log, kval=c(5,10,20,50,100,200),dim="500",p1=p1,p2=p2,ymin=6,ymax=7)
dif_100 <- get_rectange(hubness_log, kval=c(5,10,20,50,100,200),dim="100",p1=p1,p2=p2,ymin=5,ymax=6)
dif_50 <- get_rectange(hubness_log, kval=c(5,10,20,50,100,200),dim="50",p1=p1,p2=p2,ymin=4,ymax=5)
dif_10 <- get_rectange(hubness_log, kval=c(5,10,20,50,100,200),dim="10",p1=p1,p2=p2,ymin=3,ymax=4)
dif_5 <- get_rectange(hubness_log, kval=c(5,10,20,50,100,200),dim="5",p1=p1,p2=p2,ymin=2,ymax=3)
dif_2 <- get_rectange(hubness_log, kval=c(5,10,20,50,100,200),dim="2",p1=p1,p2=p2,ymin=1,ymax=2)

# Viz
ggplot(hubness_log, aes(x = Hubness_score, y = Dimension, fill = p)) +
...
```{r comp13, echo=FALSE}
# Merge the dfs
hubness_log <- rbind(hubness1_log,hubness3_log)
p1="0.1"
p2="1"
dif_9047 <- get_rectange(hubness_log, kval=c(5,10,20,50,100,200),dim="9047",p1=p1,p2=p2,ymin=9,ymax=10)
dif_5000 <- get_rectange(hubness_log, kval=c(5,10,20,50,100,200),dim="5000",p1=p1,p2=p2,ymin=8,ymax=9)
...
```{r comp14, echo=FALSE}
# Merge the dfs
hubness_log <- rbind(hubness1_log,hubness4_log)
p1="0.1"
p2="1.5"
dif_9047 <- get_rectange(hubness_log, kval=c(5,10,20,50,100,200),dim="9047",p1=p1,p2=p2,ymin=9,ymax=10)
dif_5000 <- get_rectange(hubness_log, kval=c(5,10,20,50,100,200),dim="5000",p1=p1,p2=p2,ymin=8,ymax=9)
...
```{r comp15, echo=FALSE}
# Merge the dfs
hubness_log <- rbind(hubness1_log,hubness5_log)
p1="0.1"
p2="2"
dif_9047 <- get_rectange(hubness_log, kval=c(5,10,20,50,100,200),dim="9047",p1=p1,p2=p2,ymin=9,ymax=10)
dif_5000 <- get_rectange(hubness_log, kval=c(5,10,20,50,100,200),dim="5000",p1=p1,p2=p2,ymin=8,ymax=9)
...
```{r comp16, echo=FALSE}
# Merge the dfs
hubness_log <- rbind(hubness1_log,hubness6_log)
p1="0.1"
p2="4"
dif_9047 <- get_rectange(hubness_log, kval=c(5,10,20,50,100,200),dim="9047",p1=p1,p2=p2,ymin=9,ymax=10)
dif_5000 <- get_rectange(hubness_log, kval=c(5,10,20,50,100,200),dim="5000",p1=p1,p2=p2,ymin=8,ymax=9)
