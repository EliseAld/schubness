...
data_hubness <- data_load("/Users/elise/Desktop/Github/Hubness_sc/R_scripts/load_data/hubness_load_write_data_duo.R")
data_pca <- pblapply(dataset,
                     function(x) read.table(paste0("/Users/elise/Desktop/GitHub/Hubness_sc/duo/pca/",x,"_pca_readyforhubness.csv")))
...
Dataset <- dataset
size <- c(531,531,246,263,500,499,499,222,227)
