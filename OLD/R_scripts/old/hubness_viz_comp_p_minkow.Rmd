...
```{r comp p=0.1, echo=FALSE}
# Merge the dfs
dif_1 <- get_rectange(hubness1, kval=c(5,10,20,50,100,200),dim1="2",dim2="50",p="0.1",ymin=1,ymax=2.5)
dif_2 <- get_rectange(hubness1, kval=c(5,10,20,50,100,200),dim1="50",dim2="500",p="0.1",ymin=2,ymax=3.5)
