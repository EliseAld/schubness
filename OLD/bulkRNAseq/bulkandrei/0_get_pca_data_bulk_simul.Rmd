...
data_in <- sapply(dropout_percent, function(y) paste0("/Users/elise/Desktop/GitHub/Hubness_sc/bulkRNAseq/bulkandrei/bulk_simul",y,".csv"))
data_out <- sapply(dropout_percent, function(y) paste0("/Users/elise/Desktop/GitHub/Hubness_sc/bulkRNAseq/bulkandrei/bulk_simul_pca_readyforhubness",y,".csv"))
sdev_out <- sapply(dropout_percent, function(y) paste0("/Users/elise/Desktop/GitHub/Hubness_sc/bulkRNAseq/bulkandrei/bulk_simul_pca_sdev",y,".csv"))
```
...
```{r do PCA}
data <- pblapply(X=data_in, FUN=function(x) read.table( file=x))  # 35238 x 1000
# Sparsity
