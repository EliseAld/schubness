...
library(bigSCale)
library(Matrix)
data_in <- "/Users/elise/Desktop/GitHub/Hubness_sc/data/Ewing_PDX/afterPCA/pdx_pca_readyforhubness.txt"
data_icell <- "/Users/elise/Desktop/GitHub/Hubness_sc/data/Ewing_PDX/Data/pdx_raw_merged.txt"
data_sparse <- "/Users/elise/Desktop/GitHub/Hubness_sc/data/Ewing_PDX/pdx_raw_merged.mtx"
data_icell_out <- "/Users/elise/Desktop/GitHub/Hubness_sc/data/Ewing_PDX/pdx_icell2.txt"
data_out_icell <- "/Users/elise/Desktop/GitHub/Hubness_sc/data/Ewing_PDX/pdx_icell2_pca_readyforhubness.txt"
sdev_out_icell <- "/Users/elise/Desktop/GitHub/Hubness_sc/data/Ewing_PDX/pdx_icell2_pca_sdev.txt"
```
...
data <- read.table(data_icell) # 11288 x 13319
...
seurat <- NormalizeData(seurat)
seurat <- ScaleData(seurat)
data_pooled <- GetAssayData(seurat) # 11288 x 4777
rm(seurat)
# PCA
pca <- prcomp(data_pooled)
data_proj <- t(pca$rotation)
# 4777 PCs x 4777 metacells for v1
# 936 PCs x 936 metacells for v2
