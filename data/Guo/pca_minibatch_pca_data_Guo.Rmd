...
data_icell <- "/Users/elise/Desktop/Thèse/scRNAseq/Data_sc/Guo_lung_2018/GSE99254_NSCLC.TCell.S9055.count.labeled.txt"
data_sparse <- "/Users/elise/Desktop/GitHub/Hubness_sc/data/GSE99254_NSCLC.TCell.S9047.count.labeled.mtx"
data_icell_out <- "/Users/elise/Desktop/GitHub/Hubness_sc/data/GSE99254_NSCLC.TCell.S9047.count.labeled.icell2.txt"
data_out_icell <- "/Users/elise/Desktop/GitHub/Hubness_sc/data/GSE99254_NSCLC.TCell.S9047.count.labeled.icell2_pca_readyforhubness.txt"
```
...
data <- read.table(data_icell) # 23370 x 9055
...
rownames(data_pooled) <- rownames(data)
...
seurat <- NormalizeData(seurat)
seurat <- ScaleData(seurat)
data_pooled <- GetAssayData(seurat) # 23370 x 936
rm(seurat)
# PCA
pca <- prcomp(data_pooled)
data_proj <- t(pca$rotation)
# 4519 PCs x 4519 metacells for Guo v1
# 936 PCs x 936 metacells for Guo v2
