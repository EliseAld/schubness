...
library(bigSCale)
library(Matrix)
data_in <- "/Users/elise/Desktop/GitHub/Hubness_sc/data/Baron/afterPCA/baron_pca_readyforhubness.txt"
data_icell <- "/Users/elise/Desktop/GitHub/Hubness_sc/data/Baron/data.csv"
data_sparse <- "/Users/elise/Desktop/GitHub/Hubness_sc/data/Baron/iCell/baron.mtx"
data_icell_out <- "/Users/elise/Desktop/GitHub/Hubness_sc/data/Baron/iCell/baron_icell.txt"
data_out_icell <- "/Users/elise/Desktop/GitHub/Hubness_sc/data/Baron/iCell/baron_icell_pca_readyforhubness.txt"
sdev_out_icell <- "/Users/elise/Desktop/GitHub/Hubness_sc/data/Baron/iCell/baron_icell_pca_sdev.txt"
```
...
data <- read.csv(data_icell, row.names = 1) # 14466 x 1883 
...
seurat <- NormalizeData(seurat)
seurat <- ScaleData(seurat)
data_pooled <- GetAssayData(seurat) # 14466 x 938
rm(seurat)
# PCA
