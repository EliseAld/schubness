...
data <- data@assays$data$counts # 15716 x 3994
data <- data[apply(data,1,function(x) sum(x!=0, na.rm=T))>2,] # 13001 x 3994
filter(data)
nfeature <- apply(data,2,function(x) sum(x!=0, na.rm=T))
data <- data[,nfeature<2e3]  # 13001 x 3993
write.csv(data,"/Users/elise/Desktop/GitHub/Hubness_sc/data/Zheng8/data.csv")
