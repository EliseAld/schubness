...
for (i in seq(n_dataset)) {
   for (method in c("Asymmetry", "Skewness")) {
      ...
      rgl.postscript(paste0("3DHubnessxIDxDropout_",dataset[i],"_",method,".pdf"),"pdf") 
      movie3d(spin3d(), dir="/Users/elise/Desktop/GitHub/Hubness_sc/Figure3_supp/", clean=T, duration=15, movie=paste0("3DHubnessxIDxDropout_",dataset[i],"_",method))
   }
}
