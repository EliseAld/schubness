...
def ti_analysis(adata,true_labels,do_norm,norm_scale, do_log,do_pca,
                n_neighbors,n_clusters,metric,weighted,  #weighted adjmat for louvain/leiden clustering ?
...
##### USAGE ######
resdir = "/Users/elise/Desktop/GitHub/Hubness_sc/data/forTI/zhouDR/datasets/h5_jo/"
