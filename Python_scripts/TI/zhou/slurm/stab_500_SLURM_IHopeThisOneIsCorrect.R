...
path <- "/shared/projects/hubness/TI/zhou/h5_jo/"
path_res <- "/shared/projects/hubness/TI/zhou/scores/stab_"
...
choice="zhou"
settings <- c('normduo_scaleTrue_ncomps500_cosine_louvain', 'normduo_scaleTrue_ncomps500_cosine_leiden',
