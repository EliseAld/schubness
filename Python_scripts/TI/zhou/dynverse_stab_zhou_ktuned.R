...
# ====
pdf(file=paste0("/Users/elise/Desktop/GitHub/Hubness_sc/Python_scripts/TI/zhou/bubbleplot_score_",choice,"_stab_sup_ktuned.pdf"),
...
dev.off()
pdf(file=paste0("/Users/elise/Desktop/GitHub/Hubness_sc/Python_scripts/TI/zhou/bubbleplot_score_",choice,"_stab_sup2_ktuned.pdf"),
    width=18,height=15) #sup refers to the nb of clusters chosen or not
...
dev.off()
pdf(file=paste0("/Users/elise/Desktop/GitHub/Hubness_sc/Python_scripts/TI/zhou/bubbleplot_score_",choice,"_stab_sup3_ktuned.pdf"),
    width=18,height=15) #sup refers to the nb of clusters chosen or not
lapply(seq(length(scores2)),
...
dev.off()
pdf(file=paste0("/Users/elise/Desktop/GitHub/Hubness_sc/Python_scripts/TI/zhou/bubbleplot_score_",choice,"_stab_sup4_ktuned.pdf"),
    width=18,height=15) #sup refers to the nb of clusters chosen or not
lapply(seq(length(scores2)),
       function(x) {fig=ggplot(scores2[[x]], aes(x=X, y=Y)) +
         facet_wrap(~Metric) +
...
overallscore_single <- data.frame("Score"=sapply(seq(nrow(tmp[[1]])),
                                  ...
                                  "X"=tmp[[1]]$X)
pdf(file=paste0("/Users/elise/Desktop/GitHub/Hubness_sc/Python_scripts/TI/zhou/overallscore_single_stab_ktuned.pdf"),
    width=18,height=15)
