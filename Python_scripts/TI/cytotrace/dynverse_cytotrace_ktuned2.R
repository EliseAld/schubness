...
# ====
path <- "/Users/elise/Desktop/GitHub/Hubness_sc/data/forTI/cytotrace/h5_jo_ktuned2/"
...
pblapply(settings,
         function(setting) {
           if (!file.exists(paste0(
             "/Users/elise/Desktop/GitHub/Hubness_sc/Python_scripts/TI/cytotrace/scores_scanpy_ktuned/",
             setting,
             ".rds"))) {
             ...
             saveRDS(scores_result,
                     file=paste0("/Users/elise/Desktop/GitHub/Hubness_sc/Python_scripts/TI/cytotrace/scores_scanpy_ktuned/",
                                 setting,
                                 ".rds"))
           }
...
pdf(file=paste0("/Users/elise/Desktop/GitHub/Hubness_sc/Python_scripts/TI/cytotrace/bubbleplot_score_",choice,"_goldonly",gold_only,"_sup2_ktuned.pdf"),
...
dev.off()
pdf(file=paste0("/Users/elise/Desktop/GitHub/Hubness_sc/Python_scripts/TI/cytotrace/bubbleplot_score_",choice,"_goldonly",gold_only,"_sup3_ktuned.pdf"),
    width=18,height=15) #sup refers to the nb of clusters chosen or not
lapply(seq(length(scores)),
...
dev.off()
pdf(file=paste0("/Users/elise/Desktop/GitHub/Hubness_sc/Python_scripts/TI/cytotrace/bubbleplot_score_",choice,"_goldonly",gold_only,"_sup4_ktuned.pdf"),
    width=18,height=15) #sup refers to the nb of clusters chosen or not
lapply(seq(length(scores)),
       function(x) {fig=ggplot(scores[[x]], aes(x=X, y=Y)) +
         facet_wrap(~Metric) +
...
overallscore_single <- data.frame("Score"=sapply(seq(nrow(tmp[[1]])),
                              ...
                              "X"=tmp[[1]]$X)
pdf(file=paste0("/Users/elise/Desktop/GitHub/Hubness_sc/Python_scripts/TI/cytotrace/overallscore_single_goldonly",gold_only,"_ktuned.pdf"),
    width=18,height=15)
