...
# ====
path <- "/shared/projects/hubness/TI/cytotrace/h5_jo_ktuned/"
...
pblapply(settings,
         function(setting) {
           if (!file.exists(paste0(
             "/shared/projects/hubness/TI/cytotrace/scores_ktuned/",
             setting,
             ".rds"))) {
             ...
             saveRDS(scores_result,
                     file=paste0("/shared/projects/hubness/TI/cytotrace/scores_ktuned/",
                                 setting,
                                 ".rds"))
           }
