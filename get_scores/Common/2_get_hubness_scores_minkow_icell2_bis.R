...
matrix <- read.table("/Users/elise/Desktop/GitHub/Hubness_sc/data/Zheng8/iCell/zheng8_icell2_pca_readyforhubness.txt")
print("data loaded!")
n_dim = nrow(matrix)
...
pc.val <- c(2,5,10,20,30,40,50,100,500,n_dim-1)
...
get_scores <- function(data,k.val,p.val,pc.val) {
  for (pc in pc.val) {
    ...
    for (p in p.val) {
      ...
      saveRDS(minkow, file=paste0("/Users/elise/Desktop/GitHub/Hubness_sc/results/Zheng8/icell2/kNN_occurence_",p,"_pca",pc,"_minkow_icell2_bis.rds"))
