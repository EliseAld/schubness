...
matrix <- read.table("/Users/elise/Desktop/GitHub/Hubness_sc/data/Ewing_PDX_initial/iCell/pdx1_icell_pca_readyforhubness.txt")
print("data loaded!")
n_dim = nrow(matrix)
...
get_scores <- function(data,k.val,p.val,pc.val) {
  for (pc in pc.val) {
    ...
    for (p in p.val) {
      ...
      saveRDS(minkow, file=paste0("/Users/elise/Desktop/GitHub/Hubness_sc/results/PDX1/icell/kNN_occurence_",p,"_pca",pc,"_minkow_icell_bis.rds"))
