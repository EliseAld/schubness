...
data_icell_out <- "/Users/elise/Desktop/Imagine_bckp/scRNAseq/Data_sc/hubness_data/10X/GSE100866_CBMC_8K_13AB_10X-RNA_umi.icell.txt"
data_out_icell <- "/Users/elise/Desktop/Imagine_bckp/scRNAseq/Data_sc/hubness_data/10X/GSE100866_CBMC_8K_13AB_10X-RNA_umi.icell_pca_readyforhubness.txt"
data_out_icell_sdev <- "/Users/elise/Desktop/Imagine_bckp/scRNAseq/Data_sc/hubness_data/10X/GSE100866_CBMC_8K_13AB_10X-RNA_umi.icell_pca_sdev.txt"
```

```{r do the minibatch - merging together cells close in dist and kNN graph}
data <- read.table(data_in) #  x 
library(FNN)
k=100
