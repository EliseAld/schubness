...
df2 <- readRDS("/Users/elise/Desktop/GitHub/Hubness_sc/Figure1_bulk/slurm/hubness_param_ggplot1bis.rds")
...
ggplot(df_, aes(x=Dimension, y=GHubness)) + #9x14
...
# Figure 1 supp
df_supp <- readRDS("/Users/elise/Desktop/GitHub/Hubness_sc/Figure1_bulk/slurm/hubness_param_ggplot2.rds")
df2_supp <- readRDS("/Users/elise/Desktop/GitHub/Hubness_sc/Figure1_bulk/slurm/hubness_param_ggplot2bis.rds")
...
ggplot(df_supp_, aes(x=Dimension, y=GHubness)) + # 9x7
   geom_line(aes(group=Dropout, color=Dropout)) +
   geom_point(size=0.1) +
   facet_wrap(~facet, scales = "free_y", labeller = labeller(facet = labz_method), nrow = length(dataset)) +
