---
title: "hub neighbors characteristics -Guo"
...
ggarrange(vlnplot_hub_spec_connect(seurat,"nFeature_RNA","connection",0,4200,4100),
          vlnplot_hub_spec_connect(seurat, "nCount_RNA", "connection",0,15000,14900))
# Dropout rate
...
ggarrange(vlnplot_hub_spec_connect(seurat, "percent.mt", "connection",0,26,25),
          vlnplot_hub_spec_connect(seurat, "percent.rb", "connection",0,55,54))
```
