...
pcval=c(2,5,10,20,30,40,50,100,500,(cell_nb-1))
kval=c(5,50,100,200)

localization = "/Users/elise/Desktop/Github/Hubness_sc/results/"
path_satija = "Satija/icell2/"
...
# Reorder factor
hubness$Dimension <- factor(hubness$Dimension, levels = c("2","5","10","20","30","40","50","100","500","1000",as.character(cell_nb-1)))
...
rm(localization,find_antihub_nb_per_condition,path_satija,all_paths)
