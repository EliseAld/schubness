...
```{r comp get_hub1, echo=FALSE, message=FALSE, warning=FALSE, fig.height=9, fig.width=10}
# Test p values
...
```{r comp get_hub2 & 2b, echo=FALSE, message=FALSE, warning=FALSE, fig.height=9, fig.width=10}
# Test p values
p_val_test <- c(0.1,1,2,4)
...
# Viz
ggarrange(plotlist = lapply(X=hub_musig_list, y=p_val_test, FUN=function(X,y) {plot_thd_txt(hubness, X, y, "2")}), common.legend = T)
ggarrange(plotlist = lapply(X=hub_musigb_list, y=p_val_test, FUN=function(X,y) {plot_thd_txt(hubness, X, y, "2b")}), common.legend = T)
```

```{r comp get_hub3, echo=FALSE, message=FALSE, warning=FALSE, fig.height=9, fig.width=10}
# Test p values
p_val_test <- c(0.1,1,2,4)
...
# Viz
ggarrange(plotlist = lapply(X=hub_2k_list, y=p_val_test, FUN=function(X,y) {plot_thd_txt(hubness, X, y, "3")}), common.legend = T)
```

```{r comp get_hub4, echo=FALSE, message=FALSE, warning=FALSE, fig.height=9, fig.width=10}
# Test p values
p_val_test <- c(0.1,1,2,4)
...
# Viz
ggarrange(plotlist = lapply(X=hub_skewness_list, y=p_val_test, FUN=function(X,y) {plot_evol_pval(X,method_name=paste0("Skewness, p=",y), label.y="Skewness")}), common.legend = T)
```

```{r comp get_hub5 & 5b, echo=FALSE, message=FALSE, warning=FALSE, fig.height=9, fig.width=10}
# Test p values
p_val_test <- c(0.1,1,2,4)
...
# Viz
ggarrange(plotlist = lapply(X=hub_musigleft_list, y=p_val_test, FUN=function(X,y) {plot_thd_txt(hubness, X, y, "5")}), common.legend = T)
ggarrange(plotlist = lapply(X=hub_musigleftb_list, y=p_val_test, FUN=function(X,y) {plot_thd_txt(hubness, X, y, "5b")}), common.legend = T)
```

```{r comp get_hub6, echo=FALSE, message=FALSE, warning=FALSE, fig.height=9, fig.width=10}
...
# Viz
ggarrange(plotlist = lapply(X=hub_antihub_list, y=p_val_test, FUN=function(X,y) {plot_evol_pval(X, method_name=paste0("Antihubs, p=",y), label.y = "Antihubs")}), common.legend = T)
```

```{r comp get_hub7 & 7b, echo=FALSE, message=FALSE, warning=FALSE, fig.height=9, fig.width=10}
# Test p values
p_val_test <- c(0.1,1,2,4)
...
# Viz
ggarrange(plotlist = lapply(X=hub_mad_list, y=p_val_test, FUN=function(X,y) {plot_thd_txt(hubness, X, y, "MAD")}), common.legend = T)
ggarrange(plotlist = lapply(X=hub_madb_list, y=p_val_test, FUN=function(X,y) {plot_thd_txt(hubness, X, y, "MADb")}), common.legend = T)
```

```{r comp get_hub8 & 8b, echo=FALSE, message=FALSE, warning=FALSE, fig.height=9, fig.width=10}
# Test p values
p_val_test <- c(0.1,1,2,4)
...
# Viz
ggarrange(plotlist = lapply(X=hub_mode_list, y=p_val_test, FUN=function(X,y) {plot_thd_txt(hubness, X, y, "mode")}), common.legend = T)
ggarrange(plotlist = lapply(X=hub_modeb_list, y=p_val_test, FUN=function(X,y) {plot_thd_txt(hubness, X, y, "modeb")}), common.legend = T)
```

```{r comp all, get_hub1, echo=FALSE, message=FALSE, warning=FALSE, fig.height=9, fig.width=10}
# Merge the dfs
...
```{r comp all, get_hub2, echo=FALSE, message=FALSE, warning=FALSE, fig.height=9, fig.width=10}
# Merge the dfs
...
```{r comp all, get_hub3, echo=FALSE, message=FALSE, warning=FALSE, fig.height=9, fig.width=10}
# Merge the dfs
...
```{r comp all, get_hub4, echo=FALSE, message=FALSE, warning=FALSE, fig.height=9, fig.width=10}
# Merge the dfs
...
```{r comp all, get_hub5, echo=FALSE, message=FALSE, warning=FALSE, fig.height=9, fig.width=10}
# Merge the dfs
...
```{r comp all, get_hub6, echo=FALSE, message=FALSE, warning=FALSE, fig.height=9, fig.width=10}
# Merge the dfs
...
```{r comp all, get_hub7, echo=FALSE, message=FALSE, warning=FALSE, fig.height=9, fig.width=10}
# Merge the dfs
...
```{r comp all, get_hub8, echo=FALSE, message=FALSE, warning=FALSE, fig.height=9, fig.width=10}
# Merge the dfs
...
```{r comp all, get_hub_comp, echo=FALSE, message=FALSE, warning=FALSE, fig.height=9, fig.width=10}
# Merge the dfs
#p1 <- 1
#p2 <- 2
