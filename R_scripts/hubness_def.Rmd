...
Method 7 : MAD, maybe ? but median values are sometimes equal to zero...
...
get_hub8 <- function(df,kval,dimval,pval) { # mode + 3 sigma_left
   x_thd = c()
   hub_nb = c()
   ymin = c()
   ymax = c()
...
```{r comp p=0.1 or 1 or 2, get_hub2, echo=FALSE}
# Merge the dfs
kval=c(5,10,20,50,100,200)
dimval=as.character(c(2,5,10,50,100,500,1000,5000,9047))
...
p1a <- plot_evol_pval(hub_skewness_1, pval="1", method_name="Skewness")
p2a <- plot_evol_pval(hub_skewness_2, pval="2", method_name="Skewness")
ggarrange(p0.1a,p1a,p2a, common.legend = T)
plot_evol_dimval(hub_val = hub_skewness, method_name = "Skewness", dimval=dimval)
```

```{r comp p=0.1 or 1 or 2, get_hub5, echo=FALSE}
# Merge the dfs
kval=c(5,10,20,50,100,200)
dimval=as.character(c(2,5,10,50,100,500,1000,5000,9047))
hub_musigleft_0.1 <- get_hub5(hubness, kval=kval,dimval=dimval,pval="0.1")
hub_musigleft_1 <- get_hub5(hubness, kval=kval,dimval=dimval,pval="1")
hub_musigleft_2 <- get_hub5(hubness, kval=kval,dimval=dimval,pval="2")
...
kval=c(5,10,20,50,100,200)
dimval=as.character(c(2,5,10,50,100,500,1000,5000,9047))
hub_antihub_0.1 <- get_hub6(hubness, kval=kval,dimval=dimval,pval="0.1")
hub_antihub_1 <- get_hub6(hubness, kval=kval,dimval=dimval,pval="1")
hub_antihub_2 <- get_hub6(hubness, kval=kval,dimval=dimval,pval="2")
hub_antihub <- get_hub6(hubness, kval=kval,dimval=dimval,pval=c("0.1","1","2"))

# Viz
p0.1a <- plot_evol_pval(hub_antihub_0.1, pval="0.1", method_name="Antihubs")
p1a <- plot_evol_pval(hub_antihub_1, pval="1", method_name="Antihubs")
p2a <- plot_evol_pval(hub_antihub_2, pval="2", method_name="Antihubs")
ggarrange(p0.1a,p1a,p2a, common.legend = T)
plot_evol_dimval(hub_antihub,method_name = "Antihubs",dimval=dimval)
```

```{r comp p=0.1 or 1 or 2, get_hub7, echo=FALSE}
# Merge the dfs
kval=c(5,10,20,50,100,200)
dimval=as.character(c(2,5,10,50,100,500,1000,5000,9047))
hub_mad_0.1 <- get_hub7(hubness, kval=kval,dimval=dimval,pval="0.1")
hub_mad_1 <- get_hub7(hubness, kval=kval,dimval=dimval,pval="1")
hub_mad_2 <- get_hub7(hubness, kval=kval,dimval=dimval,pval="2")
...
```{r comp p=0.1 or 1 or 2, get_hub8, echo=FALSE}
# Merge the dfs
kval=c(5,10,20,50,100,200)
dimval=as.character(c(2,5,10,50,100,500,1000,5000,9047))
hub_mode_0.1 <- get_hub8(hubness, kval=kval,dimval=dimval,pval="0.1")
hub_mode_1 <- get_hub8(hubness, kval=kval,dimval=dimval,pval="1")
hub_mode_2 <- get_hub8(hubness, kval=kval,dimval=dimval,pval="2")
...
kval <- c(5,10,20,50,100,200)
pval <- c(0.1,0.5,1,1.5,2,4)
hub_mode <- get_hub8(hubness, kval=kval,dimval=dimval,pval=pval)

# Viz
plot_evol_dimval(hub_mode, expression(paste("Global hubness defined by cells with a score above mode+3",sigma," across Lp norms")),"Hubs count")
