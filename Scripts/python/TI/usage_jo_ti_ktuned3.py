        ...
        for iter in tqdm(range(n_iter)):
            ...
            if clustering_algo == "leiden":
                clus = np.array(leidenalg.find_partition(graph=G2,
                                                         ...
                                                         seed=seed).membership)
                adata_sampled.obs['leiden'] = pd.Categorical(values=clus.astype('U'),categories=natsorted(map(str, np.unique(clus))),)
...
##### USAGE ######
resdir = "/Users/elise/Desktop/GitHub/Hubness_sc/data/forTI/zhouDR/datasets/h5_jo_ktuned4/"
resdir = "/Users/elise/Desktop/GitHub/Hubness_sc/data/forTI/cytotrace/h5_jo_ktuned4/"
